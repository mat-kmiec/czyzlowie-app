...
function showMyInstallBanner(isIOS) {
    ...
    banner.innerHTML = `
        ...
        <div id="ios-steps" style="display: none; margin-top: 15px; text-align: left; background: rgba(0,0,0,0.4); padding: 15px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05);">
            ...
            <ol style="color: #cbd5e1; font-size: 0.85rem; padding-left: 20px; line-height: 1.6; margin: 0;">
                <li style="margin-bottom: 10px;">Stuknij ikonę <strong>Udostępnij</strong> <img src="https://developer.apple.com/design/human-interface-guidelines/foundations/images/icons/sharing_share_icon_2x.png" style="width:16px; vertical-align:middle; filter: invert(1); margin: 0 2px;"> na dolnym pasku Safari.</li>
    ...
    document.getElementById('btn-pwa-decline').addEventListener('click', () => {
    ...
    document.getElementById('btn-pwa-install').addEventListener('click', async () => {
        if (isIOS) {
            document.getElementById('pwa-buttons-container').style.display = 'none';
